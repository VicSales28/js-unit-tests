...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    const testFunc = productDetails('Alcool gel', 'Máscara');
    expect((testFunc[0].details.productId).endsWith('123')).toBeTruthy();
    expect((testFunc[1].details.productId).endsWith('123')).toBeTruthy();
  });
});
